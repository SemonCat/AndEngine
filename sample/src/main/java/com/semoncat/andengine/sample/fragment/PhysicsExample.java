package com.semoncat.andengine.sample.fragment;
...
import org.andengine.ui.fragment.SimpleBaseGameFragment;
 ...
 */
public class PhysicsExample extends SimpleBaseGameFragment implements IAccelerationListener, IOnSceneTouchListener {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public EngineOptions onCreateEngineOptions() {
		Toast.makeText(getActivity(), "Touch the screen to add objects.", Toast.LENGTH_LONG).show();
	...
	public void onCreateResources() {
		...
		this.mBoxFaceTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(this.mBuildableBitmapTextureAtlas, getActivity(), "face_box_tiled.png", 2, 1);
		this.mCircleFaceTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(this.mBuildableBitmapTextureAtlas, getActivity(), "face_circle_tiled.png", 2, 1);
		this.mTriangleFaceTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(this.mBuildableBitmapTextureAtlas, getActivity(), "face_triangle_tiled.png", 2, 1);
		this.mHexagonFaceTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(this.mBuildableBitmapTextureAtlas, getActivity(), "face_hexagon_tiled.png", 2, 1);
	...
	/**
	 * Creates a {@link com.badlogic.gdx.physics.box2d.Body} based on a {@link com.badlogic.gdx.physics.box2d.PolygonShape} in the form of a triangle:
	 * <pre>
	 *  /\
	 * /__\
	 * </pre>
	...
	/**
	 * Creates a {@link com.badlogic.gdx.physics.box2d.Body} based on a {@link com.badlogic.gdx.physics.box2d.PolygonShape} in the form of a hexagon:
	 * <pre>
	 *  /\
	 * /  \
	 * |  |
