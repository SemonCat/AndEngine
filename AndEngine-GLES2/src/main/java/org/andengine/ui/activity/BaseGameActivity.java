	...
	protected synchronized void onCreateGame() {
		...
		final OnPopulateSceneCallback onPopulateSceneCallback = new OnPopulateSceneCallback() {
			...
			public void onPopulateSceneFinished() {
				try {
					if (BuildConfig.DEBUG) {
						Debug.d(BaseGameActivity.TAG + ".onGameCreated" + " @(Thread: '" + Thread.currentThread().getName() + "')");
					}

					BaseGameActivity.this.onGameCreated();
				} catch(final Throwable pThrowable) {
					Debug.e(BaseGameActivity.TAG + ".onGameCreated failed." + " @(Thread: '" + Thread.currentThread().getName() + "')", pThrowable);
				}
		...
		final OnCreateSceneCallback onCreateSceneCallback = new OnCreateSceneCallback() {
			...
			public void onCreateSceneFinished(final Scene pScene) {
				...
				try {
					if (BuildConfig.DEBUG) {
						Debug.d(BaseGameActivity.TAG + ".onPopulateScene" + " @(Thread: '" + Thread.currentThread().getName() + "')");
					}

					BaseGameActivity.this.onPopulateScene(pScene, onPopulateSceneCallback);
				} catch(final Throwable pThrowable) {
					Debug.e(BaseGameActivity.TAG + ".onPopulateScene failed." + " @(Thread: '" + Thread.currentThread().getName() + "')", pThrowable);
				}
			}
		};
		...
		final OnCreateResourcesCallback onCreateResourcesCallback = new OnCreateResourcesCallback() {
			...
			public void onCreateResourcesFinished() {
				try {
					if (BuildConfig.DEBUG) {
						Debug.d(BaseGameActivity.TAG + ".onCreateScene" + " @(Thread: '" + Thread.currentThread().getName() + "')");
					}

					BaseGameActivity.this.onCreateScene(onCreateSceneCallback);
				} catch(final Throwable pThrowable) {
					Debug.e(BaseGameActivity.TAG + ".onCreateScene failed." + " @(Thread: '" + Thread.currentThread().getName() + "')", pThrowable);
				}
			}
		};
